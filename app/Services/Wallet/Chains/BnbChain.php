...
class BnbChain implements ChainInterface
{
	use ChainTrait;
	...
	public function sendtx(array $from, string $to, $amount, $contract)
	{
		...
		$nonce = 0;
		$chainId = ($this->env == 'mainnet') ? 56 : 97;
	...
	public function callContract(array $owner, string $contract, string $method, string $abiname, string $amount){
